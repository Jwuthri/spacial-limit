...
export const IMAGE_PICKER_OPTIONS = {
  ...
  includeBase64: false, // We handle this manually now
  maxHeight: 2000,
  maxWidth: 2000,
  quality: 1.0, // Keep original quality, we'll compress later
};

// Image processing presets for different speed/quality trade-offs
